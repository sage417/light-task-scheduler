 ...
 */
public class SqlServerExecutingJobQueue extends AbstractSqlServerJobQueue implements ExecutingJobQueue {

    public SqlServerExecutingJobQueue(Config config) {
        super(config);
        // create table
        createTable(readSqlFile("sql/sqlserver/lts_executing_job_queue.sql", getTableName()));
    }
