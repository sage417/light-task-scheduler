 ...
 */
public class SqlServerJobTrackerMAccess extends SqlServerAbstractJdbcAccess implements JobTrackerMAccess {

    public SqlServerJobTrackerMAccess(Config config) {
        super(config);
    }
