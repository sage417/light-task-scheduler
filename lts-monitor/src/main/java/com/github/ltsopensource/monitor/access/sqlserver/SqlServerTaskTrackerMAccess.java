 ...
 */
public class SqlServerTaskTrackerMAccess extends SqlServerAbstractJdbcAccess implements TaskTrackerMAccess {

    public SqlServerTaskTrackerMAccess(Config config) {
        super(config);
    }
