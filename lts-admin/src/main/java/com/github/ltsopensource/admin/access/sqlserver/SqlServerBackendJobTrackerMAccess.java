...
import com.github.ltsopensource.monitor.access.sqlserver.SqlServerJobTrackerMAccess;
 ...
 */
public class SqlServerBackendJobTrackerMAccess extends SqlServerJobTrackerMAccess implements BackendJobTrackerMAccess {

    public SqlServerBackendJobTrackerMAccess(Config config) {
        super(config);
    }
