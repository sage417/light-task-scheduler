...
import com.github.ltsopensource.monitor.access.sqlserver.SqlServerJobClientMAccess;
 ...
 */
public class SqlServerBackendJobClientMAccess extends SqlServerJobClientMAccess implements BackendJobClientMAccess {

    public SqlServerBackendJobClientMAccess(Config config) {
        super(config);
    }
