...
import com.github.ltsopensource.monitor.access.sqlserver.SqlServerJVMGCAccess;
 ...
 */
public class SqlServerBackendJVMGCAccess extends SqlServerJVMGCAccess implements BackendJVMGCAccess {

    public SqlServerBackendJVMGCAccess(Config config) {
        super(config);
    }
