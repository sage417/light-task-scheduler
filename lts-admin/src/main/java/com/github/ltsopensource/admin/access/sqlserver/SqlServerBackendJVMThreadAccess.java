...
import com.github.ltsopensource.monitor.access.sqlserver.SqlServerJVMThreadAccess;
 ...
 */
public class SqlServerBackendJVMThreadAccess extends SqlServerJVMThreadAccess implements BackendJVMThreadAccess {

    public SqlServerBackendJVMThreadAccess(Config config) {
        super(config);
    }
